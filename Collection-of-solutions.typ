...
#align(center)[
  #table(
    ...
    [Sætning 2.5.1],
    [Gram-Schmidt giver ortonormal basis],
    ...
    [Definition 7.2.1],
    [Linjeintegral af skalar funktion],
    [Lemma 7.3.1],
...
#align(center)[
  #table(
    ...
    [Fejlinterval],
    [$f(x_0) in (P_n(x_0) - epsilon, P_n(x_0) + epsilon)$],
    [Grænseværdi med $epsilon$],
    [Taylor-udvid tæller; identificér laveste gradsled],
    [Tjek kontinuitet (1D)],
    ...
    [$L^2$ indre produkt for polynomier],
    [$integral_(-1)^1 f g dd(x)$; brug paritets-trick],
    [Symmetrisk matrix?],
    [Tjek $(i,j) = (j,i)$ for $i eq.not j$],
    [Adjungeret matrix $vb(B)^*$],
    [Transponer + konjuger alle indgange],
